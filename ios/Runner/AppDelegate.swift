...
@objc class AppDelegate: FlutterAppDelegate {
    ...
    override func application(_ application: UIApplication,
        ...
        batteryChannel.setMethodCallHandler({
            ...
            // to get the argumers that were send from flutter
            ...
            // to call the bottom sheet function and show the bottom sheett
    ...
    private func showBottomSheet(name: String, image: String, id: String, type: String, seat: String, isDark: Bool) {
        ...
        containerView.addSubview(roundedRectView)

        // Add Tickets text
        let ticketLab = UILabel(frame: CGRect(x: 10, y: 30, width: containerWidth - 40, height: 30))
        ticketLab.text = "Tickets :"
        ticketLab.textColor = isDark ? UIColor.white : UIColor.black
        containerView.addSubview(ticketLab)

        // Add ticket view desgin
       ...
       // Add id text view
        ...
        // this code is the doted separator  in the middle of the ticket
